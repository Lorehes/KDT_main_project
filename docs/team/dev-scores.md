...
| 2026-07-07 | Jin | bc0bf1c | fix(frontend): 공시상세 예측 배지·이유 레이아웃 분리 [3/7 S] | Frontend | 3 | 7 | S | 예측 배지·이유 레이아웃 분리 |
| 2026-07-07 | Jin | c215022 | fix(frontend): 예측 배지 블록 복구 — 라벨+이유 단일 컨테이너 [3/7 S] | Frontend | 3 | 7 | S | 예측 배지 블록 복구 |
| 2026-07-07 | Jin | afd8687 | fix(notification): 알림 이벤트 리스너 TX 누락 — fallbackExecution 수정 [8/9 S] | Notification (알림) | 8 | 9 | S | 알림 이벤트 리스너 TX 누락 수정 |
| 2026-07-08 | Jin | 9b727e1 | docs(repo): 프로젝트 리포트 추가 + .mailmap 저자 통합 [2/8 S] | Docs | 2 | 8 | S | 프로젝트 리포트+저자 통합 |
<!-- SCORES -->

...
// [이유] 인증 셸과 분리된 마케팅용 네비. 로그인 세션 감지 시 /dashboard 링크로 전환
// [사이드 임팩트] (public)/layout.tsx에서만 사용. 앱 셸 TopBar와 독립적
// [수정 시 고려사항] 스크롤에 따른 배경 불투명도 변화 추가 시 scroll listener 또는 CSS backdrop-blur 활용

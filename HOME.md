...
- [[docs/specs/Draft/topbar-global-search|TopBar 글로벌 검색]] — Draft · TopBar Enter → /disclosures?q= 라우팅, BE ILIKE 추가
- [[docs/specs/Approved/portfolio-csv-bulk-import|포트폴리오 CSV 일괄 등록]] — Approved · POST /portfolios/import 벌크 엔드포인트, FE N루프 → 단일 호출
